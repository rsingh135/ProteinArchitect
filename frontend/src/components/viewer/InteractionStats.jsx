  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6 space-y-4">
      <h3 className="text-lg font-display font-semibold text-gray-900 mb-4 flex items-center">
        <Target className="w-5 h-5 mr-2 text-gray-900" />
      ...
      {stats.simulationTime !== undefined && (
        <div className="mb-4 p-3 rounded-lg bg-blue-50 border border-blue-200">
          <div className="flex justify-between items-center text-xs">
            ...
            <span className="font-semibold text-gray-900">{(stats.simulationTime * 1000).toFixed(1)} fs</span>
          </div>
          {stats.totalEnergy !== undefined && (
            <div className="flex justify-between items-center text-xs mt-1">
              <span className="text-gray-600">Total Energy:</span>
              <span className="font-semibold text-gray-900">{stats.totalEnergy.toFixed(2)} kcal/mol</span>
            </div>
          )}
        </div>
      )}
